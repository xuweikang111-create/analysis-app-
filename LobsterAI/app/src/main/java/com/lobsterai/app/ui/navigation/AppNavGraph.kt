...
private val tabs = listOf(
    Tab("home", "伙伴", Icons.Outlined.Home),
    Tab("chat", "对话", Icons.Outlined.ChatBubbleOutline),
    Tab("knowledge", "知识", Icons.Outlined.Storage),
...
fun LobsterApp(
    ...
    LaunchedEffect(sharedContentManager) {
        sharedContentManager.incoming.collect {
            navController.openTab("knowledge")
        }
    }
        ...
        Scaffold(
            ...
            Box(
                ...
                NavHost(navController = navController, startDestination = "home") {
                    composable("home") {
                        HomeScreen(
                            onOpenChat = { navController.openTab("chat") },
                            onOpenSettings = { navController.openTab("settings") }
                        )
                    }
                    composable("chat") {
                        ChatScreen(onOpenSettings = { navController.openTab("settings") })
                    }
